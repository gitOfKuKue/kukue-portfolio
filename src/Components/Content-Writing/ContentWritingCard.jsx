  ...
  return (
    <div className="p-3 bg-aboutme flex flex-col justify-start items-start gap-3 text-font rounded-md">
      ...
      <div className="h-full flex flex-col items-start justify-start">
        ...
        <HashLink to={`/content-writings/${id}#content-writing-page`} className="bg-iconic md:py-2 md:px-4 xs:py-2 xs:px-4 sm:text-xl md:text-md xs:text-sm">More details</HashLink>
      </div>
    </div>
  )
}
