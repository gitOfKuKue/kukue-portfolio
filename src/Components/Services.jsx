...
const Services = ({service}) => {
    const date =new Date();
  return (
    <HashLink to={`#${service.toSection}`} className="service-card bg-dark text-font md:p-10 xs:p-5 xl:w-[350px] lg:w-[280px] xl:h-[340px] lg:h-[300px] flex flex-col justify-start items-start rounded-md">
