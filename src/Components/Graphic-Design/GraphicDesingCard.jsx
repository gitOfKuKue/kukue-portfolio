  ...
  return (
    <div className="p-3 bg-aboutme flex md:flex-row xs:flex-col justify-start items-start gap-3 text-font rounded-md">
      ...
      <div className="h-full flex flex-col items-start justify-start">
        ...
        <HashLink to={`/graphic-designs/${id}#graphic-design-page`} className="bg-iconic md:py-2 md:px-4 xs:py-2 xs:px-4 sm:text-xl xs:text-sm md:text-md mt-auto md:mx-0 xs:mx-auto">More details</HashLink>
      </div>
    </div>
  );
};
