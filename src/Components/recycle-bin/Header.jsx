...
const callsToAction = [
  { name: "Curriculum Vitae", href: "cv", icon: PlayCircleIcon },
  { name: "Let's talk", href: "tel:+84898247910", icon: PhoneIcon },
];
...
export default function Header() {
  ...
  return (
    <>
      <header className="bg-aboutme text-font fixed w-full z-10">
        <nav
          aria-label="Global"
