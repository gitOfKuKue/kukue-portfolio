...
const GraphicDesignCard = ({ portfolio }) => {
  ...
  return (
    <div className="p-3 2xl:min-h-[1060px] xl:min-h-[800px] lg:min-h-[780px] md:min-h-[750px] sm:min-h-[1008px] xs:h-[100px] bg-background flex flex-col justify-start items-start gap-3 text-font rounded-md">
